...
public class RandomValidateCodeUtil {
     ...
     * 生成随机图片
     */
    public void getRandcode(RedisService redisService, HttpServletResponse response) {
        ...
        //将生成的随机字符串保存到缓存中
        redisService.set(RANDOM_CODE_KEY,randomString,60*5L);
        g.dispose();
        try {
            // 将内存中的图片通过流动形式输出到客户端
