...
/*
 * @Author: zhangyong
 * description: Swagger2API文档的配置, 仅仅在dev环境下该配置才生效
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.jsxa.vapp"))
    ...
    private List<SecurityContext> securityContexts() {
        return newArrayList(
                SecurityContext.builder()
                        ...
                        .forPaths(PathSelectors.regex("^/(sys|author)/(?!(login|register)).*$"))
                        .build()
        );
    }
