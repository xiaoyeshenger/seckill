package com.jsxa.vapp.common.messagePush;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.jsxa.vapp.common.utils.Utils;
...
public class SmsClient {
    ...
    @Value("${sys.jpush.masterSecret:92d32f22f91c3cb9003ee859}")
    private String jpushMasterSecret;

    @Value("${sys.jpush.appKey:1d6b7872ea2ec176e35304a3}")
