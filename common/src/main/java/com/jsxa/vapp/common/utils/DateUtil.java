...
public class DateUtil {
    ...
    * @Date: 2020-06-22 13:33
    ...
    //将毫秒数转为*天*小时*分*秒的形式(负数即显示为-16天-21小时-11分钟-39秒)
    public static String formatDateStrByTimeStamp(Long ms) {
        String dateTimes;
        long ss = ms/1000;
        long days = ss / ( 60 * 60 * 24);
        long hours = (ss % ( 60 * 60 * 24)) / (60 * 60);
    ...
    public static String getDateTime24String() throws Exception {
