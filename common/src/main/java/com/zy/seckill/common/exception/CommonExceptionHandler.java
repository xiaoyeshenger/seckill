package com.zy.seckill.common.exception;

import com.alibaba.excel.exception.ExcelAnalysisException;
import com.zy.seckill.common.bo.vo.ResultVo;
import com.zy.seckill.common.enums.ResponseStatus;
...
public class CommonExceptionHandler {
    ...
    public ResultVo illegalArgumentException(InvalidDataAccessApiUsageException ex) {
        ex.printStackTrace();
        return ResultVo.fail(ResponseStatus.FAIL.setCode(400).setMsg(ex.getMessage().substring(0,ex.getMessage().indexOf(";"))));
    }
    ...
    public ResultVo handlerBusinessException(BusinessException e){
        ...
        return ResultVo.fail(e.getResStatus());
    }
