...
//        log.info("1-----转换前lat-baidu:" + lat + ",转换前lon-baidu:" + lon + ",转换后lat-84:" + convert6Digit(gps84[0])+ ", 转换后lon-84:" + convert6Digit(gps84[1]));
        return gps84;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Double longitude = 104.277516;
        Double latitude = 30.876721;
        String s = convert6Digit(latitude);
        System.out.println("1--->百度直接:" + s);

        double[] BD = bd09_To_gps84(latitude, longitude);

        double[] GCJ2 = bd09_To_Gcj02(latitude, longitude);
        double[] BDGCJ284 = gcj02_To_Gps84(GCJ2[0], GCJ2[1]);

        double[] GCJ284 = gcj02_To_Gps84(latitude, longitude);

        double[] doubles = bd09_To_gps84(latitude, longitude);
        System.out.println("1--->百度直接转wgs-84:" + BD[1] + "," + BD[0]);
        System.out.println("1--->百度直接转wgs-84:" + convert6Digit(BD[1]) + "," + convert6Digit(BD[0]));
        System.out.println("2--->百度转GCJ2后再转wgs-84:" + BDGCJ284[1] + "," + BDGCJ284[0]);
        System.out.println("3--->GCG2直接转wgs-84:" + GCJ284[1] + "," + GCJ284[0]);
    }

    public static String convert6Digit(Double num) {
        String result = "";
