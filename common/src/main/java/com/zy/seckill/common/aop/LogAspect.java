...
import com.zy.seckill.common.utils.IpUtil;
import com.zy.seckill.common.utils.ObjUtil;
import com.zy.seckill.common.utils.ServletUtil;
        ...
        try {
            ...
            if(!ObjUtil.isEmpty(userInfo)){
                ...
                if (!ObjUtil.isEmpty(userVo)) {
                    operLog.setOperatorName(userVo.getUsername()).setOperatorMobile(userVo.getMobileNumber()).setRegionCode(userVo.getRegionCode());
                }
            }
