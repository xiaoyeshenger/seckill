...
//            }
    ...
    public static JSONArray doPostIntercom(String apiUrl, Map<String, Object> headerMap) {
        CloseableHttpClient httpClient = null;
        if (apiUrl.startsWith("https")) {
            httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory())
                    .setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
...
//                    .setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
     ...
     * @return
     **/
    public static JSONObject doPostFormHeader(String postUrl, Map<String, Object> postParam, Map<String, Object> headerMap) {
        String rspStr = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
        try {
            //1.新建httpPost
    ...
    public static JSONObject doPostForm(String postUrl, Map<String, Object> postParam, Map<String, List<File>> fileMap, Map<String, Object> headerMap,Boolean skipHttps) {
        String rspStr = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
        if (postUrl.startsWith("https")) {
            httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory())
