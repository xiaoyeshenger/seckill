...
于xxxx-12-06，XXL-JOB参与"[2021年度OSC中国开源项目评选](https://www.oschina.net/project/top_cn_2021) "评比，在当时已录入的一万多个开源项目中角逐，最终当选"最受欢迎项目"。
...
### 7.31 版本 v2.3.0 Release Notes[xxxx-02-09]
...
- 1、【修复】修复风险漏洞，升级问题低版本项目依赖：CVE-xxxx-2471、CVE-2022-22965等。
