...
import com.zy.seckill.inventory.bo.po.Organization;
import com.zy.seckill.inventory.mapper.OrganizationMapper;
import com.zy.seckill.inventory.mapper.OrganizationDynamicSqlSupport;
import com.zy.seckill.inventory.excel.OrganizationExcelListener;
import com.zy.seckill.inventory.excel.OrganizationExcelVo;
...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    public Map<String, Object> deleteOrganizationById(Long id){
        ...
        if(organization == null){
            throw new IllegalArgumentException("id为:"+id+"的商家信息不存在");
        }
    ...
    public Map<String, Object> updateOrganization(OrganizationReqDto organizationReqDto) {
        ...
        if(ObjUtil.isEmpty(organization)){
            throw new IllegalArgumentException("id为:"+organizationReqDto.getId()+"的商家不存在");
        }
    ...
    private List<Organization> queryListByPageReqDto(OrganizationPageReqDto organizationPageReqDto,Boolean needPaging){
        ...
        String addressCode = organizationPageReqDto.getAddressCode();
        if(!ObjUtil.isEmpty(addressCode)){
            builder.and(OrganizationDynamicSqlSupport.addressCode, isEqualTo(addressCode));
        }
