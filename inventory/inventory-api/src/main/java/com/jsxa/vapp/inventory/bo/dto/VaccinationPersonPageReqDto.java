...
/*
 * @Author zhangyong
 * @Description //VaccinationPersonPageReqDto
...
public class VaccinationPersonPageReqDto extends PageReqDto {
    ...
    @ApiModelProperty(name = "startFirstDoseTime", value = "第一剂接种时间开始时间", example = "1567764943000",dataType="Long")
    @Digits(integer = 13,fraction = 0,message = "时间戳必须为13位数字(毫秒)")
    private Long startFirstDoseTime;

    @ApiModelProperty(name = "endFirstDoseTime", value = "第一剂接种时间结束时间", example = "1567764958000",dataType="Long")
    @Digits(integer = 13,fraction = 0,message = "时间戳必须为13位数字(毫秒)")
    private Long endFirstDoseTime;
    ...
    @ApiModelProperty(name = "startLatestDoseTime", value = "最近剂次接种时间开始时间", example = "1567764943000",dataType="Long")
    @Digits(integer = 13,fraction = 0,message = "时间戳必须为13位数字(毫秒)")
    private Long startLatestDoseTime;

    @ApiModelProperty(name = "endLatestDoseTime", value = "最近剂次接种时间结束时间", example = "1567764958000",dataType="Long")
    @Digits(integer = 13,fraction = 0,message = "时间戳必须为13位数字(毫秒)")
    private Long endLatestDoseTime;





    @ApiModelProperty(name = "startUpdateTime", value = "更新时间开始时间", example = "1567764943000",dataType="Long")
    @Digits(integer = 13,fraction = 0,message = "时间戳必须为13位数字(毫秒)")
    private Long startUpdateTime;

    @ApiModelProperty(name = "endUpdateTime", value = "更新时间结束时间", example = "1567764958000",dataType="Long")
    @Digits(integer = 13,fraction = 0,message = "时间戳必须为13位数字(毫秒)")
