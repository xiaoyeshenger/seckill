...
import com.jsxa.vapp.sys.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
    ...
    public Map<String, Object> addRole(String userInfo,RoleReqDto roleReqDto) {
        ...
        //(2).园区是否存在
//        Long parkId = roleReqDto.getParkId();
...
//        cacheUtil.getParkName(parkId);
    ...
    public PageVo<Map<String, Object>> getRoleListPageVo(String userInfo, RolePageReqDto rolePageReqDto){
        ...
        //3.根据查询条件封装查询命令
        //(1).关键字查询
        builder.and(RoleDynamicSqlSupport.parkId, isEqualTo(rolePageReqDto.getParkId()));
    ...
    @Override
    public List<Role> getRoleList(String userInfo) {
        List<Role> roleList = roleMapper.selectByExample()
//                .where(RoleDynamicSqlSupport.parkId,isEqualTo(parkId))
                .build()
                .execute();
        return roleList;
    }
