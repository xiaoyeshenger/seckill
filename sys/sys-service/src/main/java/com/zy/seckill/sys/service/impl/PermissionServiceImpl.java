...
import com.zy.seckill.common.bo.po.RolePermission;
...
import com.zy.seckill.sys.bo.vo.MetaVo;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Override
    @Transactional
    public Map<String, Object> addPermission(String userInfo, PermissionReqDto permissionReqDto) {

        //1.参数校验
        //字典是否存在
        //(目录和菜单可以不提交perms和url，但是按钮必须提交)
        Long permsType = permissionReqDto.getPermsType();
        cacheUtil.getDataDictName(permsType);
    ...
    @Override
    @Transactional
    public Map<String, Object> deletePermissionById(String userInfo,Long id){
        //1.权限是否存在
    ...
    @Override
    @Transactional
    public Map<String, Object> updatePermission(String userInfo,PermissionReqDto permissionReqDto) {
        ...
        //3.更新Permission
        VoPoConverterUtil.beanConverterNotNull(permissionReqDto, permission);
        permission.setPerms(permissionReqDto.getPerms());
    ...
    @Override
    public Map<String, Object> getPermissionById(String userInfo,Long id){
