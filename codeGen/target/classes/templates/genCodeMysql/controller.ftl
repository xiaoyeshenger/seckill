...
import ${basePackage}.common.bo.vo.ResultVo;
...
import ${basePackage}.common.valid.ValidationGroup;
import ${basePackage}.common.valid.ValidationGroup.ValidationUpdate;
...
public class ${pojoNameUpperCamel}Controller {
    ...
    @ApiImplicitParam(name = "id", value = "${pojoCnName}id", example = "1386532156978321", dataType = "Long", paramType = "form")
    ...
    @ApiImplicitParam(name = "id", value = "${pojoCnName}id", example = "136985121358326", dataType = "Long", paramType = "form")
