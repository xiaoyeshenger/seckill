...
import ${basePackage}.common.bo.vo.PageVo;
import ${basePackage}.common.redis.RedisKey;
import ${basePackage}.common.redis.RedisService;
...
import ${basePackageDao}.${pojoNameUpperCamel}Mapper;
import ${basePackageDao}.${pojoNameUpperCamel}DynamicSqlSupport;
import ${basePackageExcel}.${pojoNameUpperCamel}ExcelListener;
import ${basePackageExcel}.${pojoNameUpperCamel}ExcelVo;
import ${basePackage}.common.utils.*;
import ${basePackage}.common.redis.RedisService;
import ${basePackage}.common.redis.RedisKey;
import ${basePackage}.common.validator.FieldDupValidator;
...
public class ${pojoNameUpperCamel}ServiceImpl implements ${pojoNameUpperCamel}Service {
    ...
    public void downloadTemplateExcel(HttpServletResponse response){
        ...
        //2.响应文件到页面
        minioUtil.download(${pojoNameLowerCamel}.getStorePath(),${pojoNameLowerCamel}.getName(),response);*/
    }
