  ...
  <div>
      ...
      <el-col :span="24">
        ...
        >
          <el-table-column type="index" label="序号" width="55" align="center"></el-table-column>
                  <el-table-column prop="name" label="名称(3月9日第3次放苗)" align="center"></el-table-column>
          <el-table-column prop="siteId" label="接种点ID" align="center"></el-table-column>
          <el-table-column prop="siteName" label="接种点名称" align="center"></el-table-column>
          <el-table-column prop="dose" label="剂次" align="center"></el-table-column>
          <el-table-column prop="amount" label="放苗数量" align="center"></el-table-column>
          <el-table-column prop="startTime" label="市民抢苗开始时间(小程序能够开始预约)" align="center">
          ...
          <el-table-column prop="contactName" label="接种点负责人名称" align="center"></el-table-column>
          <el-table-column prop="contactMobile" label="接种点负责人电话" align="center"></el-table-column>
          <el-table-column prop="status" label="状态(0=停用,1=发布)" align="center">
            <template slot-scope="scope">
    ...
    <el-dialog title="添加" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed">
      ...
      <el-form :model="addForm" label-width="110px">
        <el-form-item label="名称(3月9日第3次放苗)" prop="name">
          <el-input v-model="addForm.name"></el-input>
        </el-form-item>
        <el-form-item label="接种点ID" prop="siteId">
          <el-input v-model="addForm.siteId"></el-input>
        </el-form-item>
        <el-form-item label="接种点名称" prop="siteName">
          <el-input v-model="addForm.siteName"></el-input>
        </el-form-item>
        <el-form-item label="剂次" prop="dose">
          <el-input v-model="addForm.dose"></el-input>
        </el-form-item>
        <el-form-item label="放苗数量" prop="amount">
          <el-input v-model="addForm.amount"></el-input>
        </el-form-item>
        <el-form-item label="市民抢苗开始时间(小程序能够开始预约)" prop="startTime">
          <el-date-picker v-model="addForm.市民抢苗开始时间(小程序能够开始预约)" type="date"
        ...
        <el-form-item label="接种点负责人名称" prop="contactName">
          <el-input v-model="addForm.contactName"></el-input>
        </el-form-item>
        <el-form-item label="接种点负责人电话" prop="contactMobile">
          <el-input v-model="addForm.contactMobile"></el-input>
        </el-form-item>
        <el-form-item label="状态(0=停用,1=发布)" prop="status">
...
import { add, deleteById, update, getById,listPage} from "@/api/vaccineRelease";
export default {
  data() {
    return {
      pageList: [], // 列表
