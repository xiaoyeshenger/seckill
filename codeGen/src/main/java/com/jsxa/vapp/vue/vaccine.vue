  ...
  <div>
      ...
      <el-col :span="24">
        ...
        >
          <el-table-column type="index" label="序号" width="55" align="center"></el-table-column>
                  <el-table-column prop="orgId" label="所属单位ID" align="center"></el-table-column>
          <el-table-column prop="orgName" label="所属单位名称" align="center"></el-table-column>
          <el-table-column prop="name" label="名称" align="center"></el-table-column>
          <el-table-column prop="manufacturer" label="厂家名称" align="center"></el-table-column>
          <el-table-column prop="batchNumber" label="生产批号" align="center"></el-table-column>
          <el-table-column prop="totalDose" label="总剂次" align="center"></el-table-column>
          <el-table-column prop="doseInterval" label="剂次间隔时间(21,60)(21代表第二剂与第一剂之间的时间间隔为21天，60代表第三剂与第一剂之间的时间间隔为60天)" align="center"></el-table-column>
          <el-table-column prop="stock" label="库存数" align="center"></el-table-column>
          <el-table-column prop="oosUrl" label="文件(列表以逗号分隔)url" align="center"></el-table-column>
          <el-table-column prop="orderNum" label="排序号" align="center"></el-table-column>
          <el-table-column prop="status" label="状态(0=停用,1=启用)" align="center">
    ...
    <el-dialog title="添加" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed">
      ...
      <el-form :model="addForm" label-width="110px">
        ...
        <el-form-item label="所属单位名称" prop="orgName">
        ...
        <el-form-item label="总剂次" prop="totalDose">
          <el-input v-model="addForm.totalDose"></el-input>
        </el-form-item>
        <el-form-item label="剂次间隔时间(21,60)(21代表第二剂与第一剂之间的时间间隔为21天，60代表第三剂与第一剂之间的时间间隔为60天)" prop="doseInterval">
          <el-input v-model="addForm.doseInterval"></el-input>
        </el-form-item>
        <el-form-item label="库存数" prop="stock">
          <el-input v-model="addForm.stock"></el-input>
        </el-form-item>
        <el-form-item label="文件(列表以逗号分隔)url" prop="oosUrl">
...
import { add, deleteById, update, getById,listPage} from "@/api/vaccine";
export default {
  data() {
    return {
      pageList: [], // 列表
