  ...
  <div>
    ...
    <el-row>
      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column prop="addressCode" label="区域码(接种点所属社区)" align="center"></el-table-column>
    ...
    <el-dialog title="添加" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed">
      ...
      <el-form :model="addForm" label-width="110px">
        ...
        <el-form-item label="区域码(接种点所属社区)" prop="addressCode">
...
import { add, deleteById, update, getById,listPage} from "@/api/vaccinationSite";
export default {
  data() {
    return {
      pageList: [], // 列表
