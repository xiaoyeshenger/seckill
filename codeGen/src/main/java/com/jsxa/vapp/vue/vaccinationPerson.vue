  ...
  <div>
      ...
      <el-col :span="24">
        ...
        >
          <el-table-column type="index" label="序号" width="55" align="center"></el-table-column>
                  <el-table-column prop="addressCode" label="区域码" align="center"></el-table-column>
    ...
    <el-dialog title="添加" :visible.sync="addDialogVisible" width="30%" @close="addDialogClosed">
      ...
      <el-form :model="addForm" label-width="110px">
        <el-form-item label="区域码" prop="addressCode">
...
import { add, deleteById, update, getById,listPage} from "@/api/vaccinationPerson";
export default {
  data() {
    return {
      pageList: [], // 列表
