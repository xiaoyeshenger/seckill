package com.jsxa.vapp.codeGen;

import com.google.common.base.CaseFormat;
import com.jsxa.vapp.codeGen.po.*;
import com.jsxa.vapp.common.bo.vo.BeanVo;
...
public class CodeGenerator {
    ...
    //1.包路径
    // 项目基础包名称
    public static final String BASE_PACKAGE = "com.jsxa.vapp";
    ...
    //生成的代码存放路径
    private static final String PACKAGE_PATH_BASE = "/src/main/java/com/jsxa/vapp/";
